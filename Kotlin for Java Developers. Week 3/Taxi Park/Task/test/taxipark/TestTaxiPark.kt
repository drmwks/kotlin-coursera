...
class TestTaxiPark {
    ...
    fun testSmartPassengers2() {
        val tp = taxiPark(1..3, 1..3,
                trip(3, listOf(3, 2), discount = 0.4),
                trip(2, listOf(3, 2, 1)),
                trip(1, listOf(3, 1), discount = 0.4),
                trip(1, listOf(3, 2), discount = 0.2),
                trip(2, listOf(3, 2, 1)),
                trip(3, listOf(2)),
                trip(1, listOf(1), discount = 0.3),
                trip(1, listOf(3, 1)),
                trip(1, listOf(3, 1), discount = 0.2),
                trip(1, listOf(3), discount = 0.1),
                trip(2, listOf(3, 1)),
                trip(3, listOf(3, 1), discount = 0.2))
        Assert.assertEquals("Wrong result for 'findSmartPassengers()'." + tp.display(),
                passengers(3), tp.findSmartPassengers())
    }
